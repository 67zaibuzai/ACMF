...
_C.IMAGE_PATH = r'D:\沙盘新数据\毕设数据\毕设数据\all_sp_images'
_C.OPTION_PATH = r'D:\67\doit\exps\data\labels\new_data\Operation.xlsx'
_C.SEMANTIC_PATH = r'D:\67\doit\exps\data\labels\new_data\Emo.xlsx'
_C.LABEL_PATH = r'D:\67\doit\exps\data\labels\new_data\all_label_6208.xlsx'
...
_C.DATASET.GET_TXT_FEATURE = True
...
_C.AUG.TIMM_AUG.USE_TRANSFORM = True

# QUEUE
_C.QUEUE = CN(new_allowed=True)
...
_C.TEST.VALID_RATIO = 0.2

_C.FINETUNE = CN(new_allowed=True)
...
def update_config(config, args):
    ...
    config.defrost()
    # args.opts 是一个 列表形式的键值对，通常来自命令行
    ...
    config.WORLD_SIZE = comm.world_size
